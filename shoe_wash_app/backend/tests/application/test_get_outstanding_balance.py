...
def test_sums_unpaid_balance_across_all_loads(load_repo):
    ...
    load_repo.add(Load(
        id=None, dropped_off_at=datetime.now(), customer_id=2,
        items=[LoadItem(id=None, item_class_id=1, quantity=1, price_charged=3000)],
        amount_paid=3000,  # fully paid, excluded
    ))
